...
const stats = [
  ...
  { id: 2, label: "Employees", value: "37" },
  { id: 3, label: "Countries", value: "12" },
  { id: 4, label: "Raised", value: "$25M" },
];

export default function Welcome() {
  return (
    <div className="w-full mx-auto grid grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:grid-cols-2">
      <div className="lg:pr-4 justify-self-end">
        <div className="relative overflow-hidden rounded-box bg-gray-700 bg-blend-soft-light px-6 pt-64 pb-9 shadow-md sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
          <Image
            alt="Pedn Vounder"
            src="/images/pedn-vounder.jpg"
            fill
            className="absolute inset-0 size-full object-cover brightness-100 saturate-0 mix-blend-overlay"
          />
          <div className="absolute inset-0 bg-primary opacity-30 mix-blend-overlay" />
          <div
            aria-hidden="true"
