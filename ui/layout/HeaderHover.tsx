...
export default function HeaderHover() {
   ...
   * submenus on hover
   */
  const [openSubmenuId, setSubmenuOpenId] = useState<number>(0);
  ...
  const handleMouseLeave = () => {
    timeoutRef.current = setTimeout(() => setSubmenuOpenId(0), 300);
  };
      ...
      >
        ...
        <div className="flex lg:hidden">
          <button
            ...
            className={`${isHomePage ? "text-white" : "text-primary"} -m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700`}
          >
