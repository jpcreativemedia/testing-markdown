...
import { lastestNews } from "@/data/news";
import { formatDate } from "@/utils/formatDate";

export default async function LatestNews() {
  const news = await lastestNews();
  return (
    <div className="w-full">
      ...
      <div className="mx-auto mt-10 w-full grid grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
        {news.map((article) => (
          <article
